...
<section>
    <div class="container mt-2">
        ...
        <div class="card-group justify-content-center">
            ...
            <img class="card-img-top w-100 d-block" src="<?php echo e('/public/storage/'.$product->img); ?>" />
                <div class="card-body">
                    <h6 class="text-success float-right card-title"><?php echo e($product->price); ?></h6>
                    <h4 class="card-title">{<?php echo $product->title; ?>} </h4>
                    <p class="card-text">{<?php echo html_entity_decode($product->description); ?>}</p>
...
<?php /**PATH C:\xampp\htdocs\TalkBuyApp1\resources\views/product/index.blade.php ENDPATH**/ ?>